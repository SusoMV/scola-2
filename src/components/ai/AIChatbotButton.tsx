...
const AIChatbotButton: React.FC<AIChatbotButtonProps> = ({ 
  ...
  return (
    <Button
      variant="outline"
      className={cn(
        "flex flex-col items-center justify-center gap-2 h-32 w-full p-4",
        "border border-gray-200 bg-white hover:bg-scola-pastel hover:text-scola-primary hover:border-scola-primary",
