        ...
        <div className="mb-6">
          <div className="flex items-center gap-4">
            ...
            <label 
              ...
              className="flex items-center gap-2 bg-scola-primary text-white px-4 py-2 rounded cursor-pointer hover:bg-scola-primary/90 transition-colors"
            >
              <Upload className="h-4 w-4" />
              Subir documento
            </label>
            <span className="text-sm text-gray-500">
              Selecciona un arquivo para subir
            </span>
          </div>
        </div>
