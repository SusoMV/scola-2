...
const ClassroomPlanningUploader = () => {
  const { documents, isLoading, addDocument, deleteDocument, downloadDocument } = useDocuments('planning');
...
export default ClassroomPlanningUploader;
