  ...
  return (
    <DashboardLayout>
      ...
      <div className="space-y-6">
        <DocumentUploader title="Subir actas" category="meeting-minutes" />
        
        <div className="bg-white p-6 rounded-md shadow-sm">
          <h2 className="text-lg font-medium mb-4">Actas subidas</h2>
          
          {isLoading ? (
            <p className="text-center py-4">Cargando actas...</p>
          ) : documents.length === 0 ? (
            <p className="text-center text-gray-500 py-4">Non hai actas subidas</p>
          ) : (
            <Table>
              <TableHeader>
                <TableRow>
