...
const AIChatbotButton: React.FC<AIChatbotButtonProps> = ({
  ...
  return (
    <button 
      className={cn(
        "flex flex-col items-center justify-center h-32 w-full p-4",
        "border border-dashed border-blue-300 rounded-lg",
    ...
    >
      ...
      <span className="text-center font-medium text-sm text-gray-700">{name}</span>
    </button>
  );
};
