...
const WelcomeSection: React.FC<WelcomeSectionProps> = ({ userName }) => {
  ...
  const schoolId = user?.user_metadata?.school_id || '15013643';
  const schoolName = user?.user_metadata?.school_name || 'CEIP Plurilingüe A Magdalena';
