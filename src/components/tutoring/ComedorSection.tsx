        ...
        <CardContent className="p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-2">
              <Button onClick={() => setIsCourseManageDialogOpen(true)} className="bg-scola-primary">
                <FolderPlus className="mr-2 h-4 w-4" />
                Añadir/eliminar curso
              </Button>
              <Button onClick={() => setIsManageDialogOpen(true)} className="bg-scola-primary">
          ...
          <CoursesGrid courses={courses} onCourseClick={handleCourseClick} />
        </CardContent>
      </Card>
