...
const TeacherSchedulesUploader = () => {
  const {
    documents,
    isLoading,
    addDocument,
    deleteDocument,
    downloadDocument
  } = useDocuments('teacher-schedules');
    ...
    <Card className="shadow-sm border-gray-200">
      <CardHeader className="pb-2">
        <CardTitle className="text-lg font-medium flex items-center justify-between">
          <div>Horarios do profesorado</div>
      ...
      <CardContent>
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            {documents.map(doc => (
              <div key={doc.id} className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 transition-colors my-[13px] py-[10px]">
...
export default TeacherSchedulesUploader;
